...
<body>
  ...
  <section class="site-hero overlay  " data-stellar-background-ratio="0.5"
    ...
    <div class="container  ">
      <div class="row align-items-center site-hero-inner ">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          <form action="index.php" method="POST"
            style="background:beige;; margin-left: 100px; margin-top: 50px; padding: 10px; border-radius: 6px; box-shadow: 0 0 5px rgba(0,0,0,0.1); width: 100%; max-width: 340px; font-family: sans-serif;">

            <h4 style="text-align: center; margin: 5px 0 10px; font-size: 16px; color: #222;">Reservation</h4>

            <label style="font-size: 12px; margin: 2px 0; display: block;" id="name" name="Name">Name *</label>
            <input type="text" id="name" name="Name" required
              style="width: 100%; padding: 5px; font-size: 12px; border: 1px solid #ccc; border-radius: 3px;">

            <label style="font-size: 12px; margin: 4px 0 2px; display: block;">Email *</label>
            <input type="email" id="email" name="Email" required
              style="width: 100%; padding: 5px; font-size: 12px; border: 1px solid #ccc; border-radius: 3px;">

            <label style="font-size: 12px; margin: 4px 0 2px; display: block;">Phone *</label>
            <input type="tel" id="phone" name="Phone" required
              style="width: 100%; padding: 5px; font-size: 12px; border: 1px solid #ccc; border-radius: 3px;">

            <label style="font-size: 12px; margin: 4px 0 2px; display: block;">Check-In *</label>
            <input type="date" id="checkin" name="Checkin" required
              style="width: 100%; padding: 5px; font-size: 12px; border: 1px solid #ccc; border-radius: 3px;">

            <label style="font-size: 12px; margin: 4px 0 2px; display: block;">Check-Out *</label>
            <input type="date" name="Checkout" id="checkout" required
              style="width: 100%; padding: 5px; font-size: 12px; border: 1px solid #ccc; border-radius: 3px;">

            <label style="font-size: 12px; margin: 4px 0 2px; display: block;">Guests *</label>
            <input type="number" id="guest" name="Guest" min="1" required
              style="width: 100%; padding: 5px; font-size: 12px; border: 1px solid #ccc; border-radius: 3px;">

            <label style="font-size: 12px; margin: 4px 0 2px; display: block;">Room *</label>
            ...
            <textarea name="Request" id="request" rows="1" placeholder="Requests (optional)"
              style="width: 100%; margin-top: 4px; padding: 5px; font-size: 12px; border: 1px solid #ccc; border-radius: 3px;"></textarea>

            <button type="submit" name="submit"
              style="margin-top: 8px; width: 100%; padding: 6px; font-size: 13px; background: rgb(190, 127, 76); color: #fff; border: none; border-radius: 3px; cursor: pointer;">Submit</button>
          </form>
